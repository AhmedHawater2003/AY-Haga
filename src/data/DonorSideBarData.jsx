...
export const DonorSideBarData = [
  {
    title: "Home",
    content: <DonationsGrid data={allData} isDoner={true} isFullfilled={false} isPending={false} isWaiting={false} />,
    ...
    subNav: [
      {
        ...
        title: "As a Teacher",
        content: <DonationsGrid data={TeachingData} isVolunteer={true} isDoner={true} isFullfilled={false} isPending={false} isWaiting={false} />,
