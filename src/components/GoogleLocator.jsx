  ...
  const handlePointClick = async (point) => {
    ...
    try {
      const response = await fetch(
        `https://api.geoapify.com/v1/geocode/reverse?lat=${point[0]}&lon=${point[1]}&apiKey=e84e2c145c33490389e48c236e3cf970`
      );
      ...
      setGovernorate(
        data.features[0].properties.state || "Governorate not found"
      );
    } catch (error) {
