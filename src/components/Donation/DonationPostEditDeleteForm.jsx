...
const DonationPostEditDeleteForm = ({item , deletePost , back}) => {
  ...
  const handleBack = () => {
    ...
    const [additionalDetails , setAdditionalDetails] = useState('There are many homeless people in the streets we need to help them as a part of giving back of what we have');
    //Errors
  ...
  return (
    ...
    <div>
      ...
      <DeleteConfirmationModal item = {item} deletePost = {deletePost} back = {back} />
    </div>
