                                ...
                                <div className="row form">
                                    ...
                                    <div className="col-lg-10 text-center mx-auto">
                                        ...
                                        <Form noValidate validated={validated} style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }} onSubmit={handleSubmit}>
                                            {wrong && <Form.Group style={formGroupStyling}>
                                                <Alert variant="danger" style={{ width: "100%" }}>
                                                    Invalid Email or Password
                                                </Alert>
                                            </Form.Group>
                                            }
                                            {right && <Form.Group style={formGroupStyling}>
                                        ...
                                        <div className="text-center mt-4">
                                            ...
                                            <a href="/register">
                                                <button className="btn text-uppercase" style={{ marginBottom: "15px" }}>Register</button>
                                            </a>
                                        </div>
                                    </div>
                                </div>
