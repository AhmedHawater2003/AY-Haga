...
const OrganizationsRegForm = () => {
    ...
    const handleClose = () => { setShow(false); setShowAlert(false); setValidated(false); }
        ...
        <>
            ...
            <Modal show={show} onHide={handleClose} size="lg">
                <Modal.Header closeButton>
                    <Modal.Title style={modalTitleStyling}>Organization Registeration </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    ...
                    {!showAlert &&
                        <Form noValidate validated={validated} style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }} onSubmit={handleSubmit}>
                            ...
                            <Form.Group style={formGroupStylingRadios}  >
                                ...
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="radio" name="inlineRadioOptions1" id="inlineRadio2" value="option2" required />
                            ...
                            <Form.Group style={formGroupStyling} >
                                <Form.Label style={labelStyling}>Organization address:</Form.Label>
                                {address !== "" ? (
                                    <Form.Control
                                        style={styling}
                                        type="text"
                            ...
                            <Form.Group style={formGroupStyling} >
                                <Form.Label style={labelStyling}><i>OR</i><br/>Pin your organization location:</Form.Label>
                            ...
                            <Form.Group style={formGroupStyling}>
                                <Form.Label style={labelStyling}>upload your document(s) :</Form.Label>
