        ...
        <Modal.Body>
          ...
          <Form style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }} onSubmit={handleSubmit}>
            ...
            <Form.Group style={{ width: "80%" }} controlId="exampleForm.ControlInput1">
              ...
              form-check-inline">
                <input className="form-check-input" type="radio" onChange={handleDoctor} name="inlineRadioOptions3" id="inlineRadio3" value="option1" />
                <label className="form-check-label" htmlFor="inlineRadio3">Pro-bono Doctor</label>
              </div>
              <div className="form-check
              form-check-inline">
                <input className="form-check-input" type="radio" onChange={handleTeacher} name="inlineRadioOptions4" id="inlineRadio4" value="option2" />
                <label className="form-check-label" htmlFor="inlineRadio4">Pro-bono Teacher</label>
              </div>
              <div className="form-check
              form-check-inline">
                <input className="form-check-input" type="radio" onChange={handleNo} name="inlineRadioOptions5" id="inlineRadio5" value="option3" />
                <label className="form-check-label" htmlFor="inlineRadio5"> Regular donor</label>
              </div>
            </Form.Group>

            {doctor && <Form.Group style={{ width: "80%" }} controlId="exampleForm.ControlInput1">
              ...
              <br />
              <Form.Label style={{ fontSize: "20px", textDecoration: "underline" }}>Clinic details</Form.Label>
